...
NS_IMPL_QUERY_INTERFACE_INHERITED1(nsMathMLmtableOuterFrame, nsTableOuterFrame, nsIMathMLFrame)
...
nsresult
nsMathMLmtableOuterFrame::MoveOutToRight(nsIFrame * leavingFrame, nsIFrame** aOutFrame, PRInt32* aOutOffset, PRUint32& count)
{
...
nsresult
nsMathMLmtableOuterFrame::MoveOutToLeft(nsIFrame * leavingFrame, nsIFrame** aOutFrame, PRInt32* aOutOffset, PRUint32& count)
{                
...
nsresult
nsMathMLmtableOuterFrame::EnterFromLeft(nsIFrame** aOutFrame, PRInt32* aOutOffset, PRUint32& count)
{
...
nsresult
nsMathMLmtableOuterFrame::EnterFromRight(nsIFrame** aOutFrame, PRInt32* aOutOffset, PRUint32& count)
{
...
nsresult
nsMathMLmtableFrame::MoveOutToRight(nsIFrame * leavingFrame, nsIFrame** aOutFrame, PRInt32* aOutOffset, PRUint32& count)
{
  printf("containerframe MoveOutToRight, count = %d\n", count);
  // default behavior is to pass it on to the children
  nsIFrame* pFrame = GetFirstChild(nsnull);
...
nsresult
nsMathMLmtableFrame::MoveOutToLeft(nsIFrame * leavingFrame, nsIFrame** aOutFrame, PRInt32* aOutOffset, PRUint32& count)
{                
  printf("containerframe MoveOutToLeft, count = %d\n", count);
  // same as above, but backwards in a singly-linked list
  nsCOMPtr<nsMathMLFrame> pMathMLFrame;
...
nsresult
nsMathMLmtableFrame::EnterFromLeft(nsIFrame** aOutFrame, PRInt32* aOutOffset, PRUint32& count)
{
  printf("containerframe EnterFromLeft, count = %d\n", count);
  nsIFrame * pFrame = GetFirstChild(nsnull);
  nsIContent * pContent;
...
nsresult
nsMathMLmtableFrame::EnterFromRight(nsIFrame** aOutFrame, PRInt32* aOutOffset, PRUint32& count)
{
  printf("containerframe EnterFromRight, count = %d\n", count);
  nsIFrame * pFrame = GetFirstChild(nsnull);
  nsCOMPtr<nsMathMLFrame> pMathMLFrame;
...
nsresult
nsMathMLmtrFrame::MoveOutToRight(nsIFrame * leavingFrame, nsIFrame** aOutFrame, PRInt32* aOutOffset, PRUint32& count)
{
  printf("containerframe MoveOutToRight, count = %d\n", count);
  // default behavior is to pass it on to the children
  nsIFrame* pFrame = GetFirstChild(nsnull);
  ...
  if (pFrame)
  {
    ...
    if (pMathMLFrame) pMathMLFrame->EnterFromLeft(aOutFrame, aOutOffset, count);
      ...
      printf("nsMathMLmtrFrame has non-MathML child\n");  //could be a text node BBM: fix this
  }
  else     
  {
    pFrame = GetParent();
...
nsresult
nsMathMLmtrFrame::MoveOutToLeft(nsIFrame * leavingFrame, nsIFrame** aOutFrame, PRInt32* aOutOffset, PRUint32& count)
{                
  printf("containerframe MoveOutToLeft, count = %d\n", count);
  // same as above, but backwards in a singly-linked list
  nsCOMPtr<nsMathMLFrame> pMathMLFrame;
...
nsresult
nsMathMLmtrFrame::EnterFromLeft(nsIFrame** aOutFrame, PRInt32* aOutOffset, PRUint32& count)
{
  printf("containerframe EnterFromLeft, count = %d\n", count);
  nsIFrame * pFrame = GetFirstChild(nsnull);
  nsIContent * pContent;
...
nsresult
nsMathMLmtrFrame::EnterFromRight(nsIFrame** aOutFrame, PRInt32* aOutOffset, PRUint32& count)
{
  printf("containerframe EnterFromRight, count = %d\n", count);
  nsIFrame * pFrame = GetFirstChild(nsnull);
  nsCOMPtr<nsMathMLFrame> pMathMLFrame;
  ...
  while (pFrame->GetNextSibling() != nsnull)
    pFrame = pFrame->GetNextSibling();
  if (!pFrame) printf("Error in nsMathMLmtrFrame::EnterFromRight()\n");   
  else
  {
    pMathMLFrame = do_QueryInterface(pFrame);
    if (pMathMLFrame) pMathMLFrame->EnterFromRight(aOutFrame, aOutOffset, count);
...
nsresult
nsMathMLmtdFrame::MoveOutToRight(nsIFrame * leavingFrame, nsIFrame** aOutFrame, PRInt32* aOutOffset, PRUint32& count)
{
  printf("containerframe MoveOutToRight, count = %d\n", count);
  // default behavior is to pass it on to the children
  nsIFrame* pFrame = GetFirstChild(nsnull);
...
nsresult
nsMathMLmtdFrame::MoveOutToLeft(nsIFrame * leavingFrame, nsIFrame** aOutFrame, PRInt32* aOutOffset, PRUint32& count)
{                
  printf("containerframe MoveOutToLeft, count = %d\n", count);
  // same as above, but backwards in a singly-linked list
  nsCOMPtr<nsMathMLFrame> pMathMLFrame;
...
nsresult
nsMathMLmtdFrame::EnterFromLeft(nsIFrame** aOutFrame, PRInt32* aOutOffset, PRUint32& count)
{
  printf("containerframe EnterFromLeft, count = %d\n", count);
  nsIFrame * pFrame = GetFirstChild(nsnull);
  nsIContent * pContent;
...
nsresult
nsMathMLmtdFrame::EnterFromRight(nsIFrame** aOutFrame, PRInt32* aOutOffset, PRUint32& count)
{
  printf("containerframe EnterFromRight, count = %d\n", count);
  nsIFrame * pFrame = GetFirstChild(nsnull);
  nsCOMPtr<nsMathMLFrame> pMathMLFrame;
...
NS_IMPL_QUERY_INTERFACE_INHERITED1(nsMathMLmtdInnerFrame, nsBlockFrame, nsIMathMLFrame)
...
nsresult
nsMathMLmtdInnerFrame::MoveOutToRight(nsIFrame * leavingFrame, nsIFrame** aOutFrame, PRInt32* aOutOffset, PRUint32& count)
{
  printf("containerframe MoveOutToRight, count = %d\n", count);
  // default behavior is to pass it on to the children
  nsIFrame* pFrame = GetFirstChild(nsnull);
...
nsresult
nsMathMLmtdInnerFrame::MoveOutToLeft(nsIFrame * leavingFrame, nsIFrame** aOutFrame, PRInt32* aOutOffset, PRUint32& count)
{                
  printf("containerframe MoveOutToLeft, count = %d\n", count);
  // same as above, but backwards in a singly-linked list
  nsCOMPtr<nsMathMLFrame> pMathMLFrame;
...
nsresult
nsMathMLmtdInnerFrame::EnterFromLeft(nsIFrame** aOutFrame, PRInt32* aOutOffset, PRUint32& count)
{
  printf("containerframe EnterFromLeft, count = %d\n", count);
  nsIFrame * pFrame = GetFirstChild(nsnull);
  nsIContent * pContent;
...
nsresult
nsMathMLmtdInnerFrame::EnterFromRight(nsIFrame** aOutFrame, PRInt32* aOutOffset, PRUint32& count)
{
  printf("containerframe EnterFromRight, count = %d\n", count);
  nsIFrame * pFrame = GetFirstChild(nsnull);
  nsCOMPtr<nsMathMLFrame> pMathMLFrame;
