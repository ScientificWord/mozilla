...
var gEngineConsole, gConsoleBundle;

/* :::::::: Console Initialization ::::::::::::::: */

window.onload = function()
{
  gEngineConsole = document.getElementById("EngineConsoleBox");
  gConsoleBundle = document.getElementById("ConsoleBundle");
  
  updateSortCommand(gEngineConsole.sortOrder);
//  updateModeCommand(gEngineConsole.mode);

//  gEvaluator.addEventListener("load", loadOrDisplayResult, true);
  changeMode("Engine messages");
}
...
function changeMode(aMode)
{
  switch (aMode) {
    ...
    case "Warnings":
    case "Messages":
    case "Engine messages":
      gEngineConsole.mode = aMode;
      break;
    case "All":
      gEngineConsole.mode = null;
  }
...
{
  gEngineConsole.clear();
}

function changeSortOrder(aOrder)
{
  updateSortCommand(gEngineConsole.sortOrder = aOrder);
}
