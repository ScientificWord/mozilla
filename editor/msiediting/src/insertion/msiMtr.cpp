...
#include "msiUtils.h"
msiMtr::msiMtr(nsIDOMNode* mathmlNode, PRUint32 offset)
:  msiMInsertionBase(mathmlNode, offset, MATHML_MTR)
{
}

NS_IMETHODIMP
msiMtr::InsertNode(nsIEditor * editor,
...
NS_IMETHODIMP
msiMtr::InsertMath(nsIEditor * editor,
                   nsISelection  * selection, 
                   PRBool isDisplay,
                   nsIDOMNode * left,    
                   nsIDOMNode * right,    
...
NS_IMETHODIMP 
msiMtr::Inquiry(nsIEditor * editor,
                PRUint32 inquiryID, 
                PRBool * result)
{
  nsresult res(NS_OK);
...
NS_IMETHODIMP
msiMtr::InsertNodes(nsIEditor * editor,
                               nsISelection * selection, 
                               nsIArray * nodeList,
