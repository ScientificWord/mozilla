...
#define RLM_REVISION 2
#define RLM_BUILD 2
#define RLM_PATCH 0

#define RLM_SOFTWARE_VERSION  "Reprise License Manager (RLM) v11.2, Copyright (C) 2006-2014, Reprise Software, Inc."
#define RLM_COPYRIGHT  "Copyright (C) 2006-2014, Reprise Software, Inc. All rights reserved."
...
extern int			rlm_act_set_handle(RLM_ACT_HANDLE handle,
						int what, void *val);
extern int			rlm_act_revoke(RLM_HANDLE rh, const char *url,
							char *product);
extern int			rlm_act_revoke_reference(RLM_HANDLE rh, 
							const char *url,
							char *product);
extern int			rlm_act_revoke_disconn(RLM_HANDLE rh, 
							const char *url,
							char *param,
							char *retval);
...
#define RLM_EH_CACHEWRITEERR	-172	/* Roam File write error */
#define RLM_EH_CACHEREADERR	-173	/* Roam File read error */
#define RLM_EH_LIC_WITH_NEW_KEYWORDS -174 /* License returned from server has keywords I don't understand */

#define RLM_EH_MAX_ERRS 74
