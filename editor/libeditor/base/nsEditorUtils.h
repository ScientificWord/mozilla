...
class nsEditorUtils
{
  public:
    ...
    static PRBool Acceptable(nsEditor * ed, msiITagListManager * tlm, nsIDOMNode * node);
    static PRBool JiggleCursor(nsIEditor *aEditor, nsISelection * sel, nsIEditor::EDirection dir);
};
