...
//                                         command, commandHandler, "")
  ...
  window.openDialog("chrome://editor/content/EdInsertTable.xul", "inserttable", "chrome,close,titlebar,dependent,resizable", "");
  editorElement.focus();
}
...
function msiEditorTableCellProperties(editorElement)
{
  ...
  try {
    ...
    if (cell) {
      ...
      //HERE USE MODELESS DIALOG FUNCTIONALITY!
      window.openDialog("chrome://editor/content/EdTableProps.xul", "tableprops", "chrome,close,titlebar,dependent,resizable", "", "CellPanel");
      editorElement.focus();
    }
  } catch (e) {}
}
