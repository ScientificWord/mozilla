...
function Startup()
{
  window.msiParentEditor = msiGetParentEditorElementForDialog(window);
  ...
  gPersistObj = window.opener.msiStartPublishing(editorElement);
}
...
function onClose()
{
  ...
  window.opener.msiFinishPublishing(window.msiParentEditor);
  return true;
}
