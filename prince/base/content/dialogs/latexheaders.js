...
// Two data items are passed into this dialog in a single object: 
// window.arguments[0]: the object, with two parts:
// .lheader is the left header
// .rheader is the right header 


// Populate the dialog with the current values passed to the dialog
function Startup(){ 
  window.arguments.Cancel = false;
  var data = window.arguments[0];                    
  doSetOKCancel(OK, Cancel);
...
function buildEditorTable () {
  var str = "";
  // put the expression in its own table
  var lheader = window.arguments[0].lheader;
  var rheader = window.arguments[0].rheader;
  str += "<table chrome=\"1\" width=\"100%\" xmlns=\"http://www.w3.org/1999/xhtml\">";
  str += "<tbody>";
  str += "<tr width=\"800px\" >";
  atr += "<td class=\"label\" width=\"5%\"/>";                               
  str += "<td class=\"label\"  width=\"30%\">";               
  str += "Left header";                               
  str += "</td><td class=\"label\" width=\"5%\"/>";
  str += "<td id = \"lheader\" class=\"value\" width=\"60%\">" + lheader + "</td></tr>";                              
  str += "<tr>";
  atr += "<td class=\"label\"/>";                               
  str += "<td class=\"label\" flex = \"1\">";               
  str += "Right header";                               
  str += "</td><td class=\"label\"/>";
  str += "<td id = \"rheader\" class=\"value\" >" +rheader + "</td></tr>";                              
  str += "<tr>";                               
  str += "</tr></tbody></table>";
...
function OK(){
  ...
  window.arguments[0].lheader=doc.getElementById("lheader").textContent;             
  window.arguments[0].rheader=doc.getElementById("rheader").textContent;             
//  SaveWindowLocation();
  return true;
}                          
