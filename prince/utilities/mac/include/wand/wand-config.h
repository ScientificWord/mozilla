...
#define MagickCoderModulesPath "/usr/local/lib/ImageMagick-6.3.3/modules-Q16/coders/"

/* Subdirectory of lib where coder modules are installed */
#define MagickCoderModulesSubdir "ImageMagick-6.3.3/modules-Q16/coders"

/* Directory where ImageMagick documents live. */
#define MagickDocumentPath "/usr/local/share/doc/ImageMagick-6.3.3/"

/* Location of filter modules */
#define MagickFilterModulesPath "/usr/local/lib/ImageMagick-6.3.3/modules-Q16/filters/"

/* Subdirectory of lib where filter modules are installed */
#define MagickFilterModulesSubdir "ImageMagick-6.3.3/modules-Q16/filters"

/* Directory where architecture-dependent configuration files live. */
#define MagickLibConfigPath "/usr/local/lib/ImageMagick-6.3.3/config/"

/* Subdirectory of lib where architecture-dependent configuration files live.
   */
#define MagickLibConfigSubDir "ImageMagick-6.3.3/config"

/* Directory where architecture-dependent files live. */
#define MagickLibPath "/usr/local/lib/ImageMagick-6.3.3/"

/* Subdirectory of lib where ImageMagick architecture dependent files are
   installed */
#define MagickLibSubdir "ImageMagick-6.3.3"

/* Magick API method prefix */
/* #undef MagickMethodPrefix */

/* Directory where architecture-independent configuration files live. */
#define MagickShareConfigPath "/usr/local/share/ImageMagick-6.3.3/config/"

/* Subdirectory of lib where architecture-independent configuration files
   live. */
#define MagickShareConfigSubDir "ImageMagick-6.3.3/config"

/* Directory where architecture-independent files live. */
#define MagickSharePath "/usr/local/share/ImageMagick-6.3.3/"
