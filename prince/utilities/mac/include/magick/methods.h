...
#define Contrast  PrependMagickMethod(Contrast)
...
#define CreatesRGBImageProfile  PrependMagickMethod(CreatesRGBImageProfile)
...
#define ExecuteModuleProcess  PrependMagickMethod(ExecuteModuleProcess)
...
#define GetMagickDecoder  PrependMagickMethod(GetMagickDecoder)
#define GetMagickDescription  PrependMagickMethod(GetMagickDescription)
#define GetMagickEncoder  PrependMagickMethod(GetMagickEncoder)
...
#define HSBTransform  PrependMagickMethod(HSBTransform)
...
#define Hull  PrependMagickMethod(Hull)
#define HWBTransform  PrependMagickMethod(HWBTransform)
...
#define ListMagickOptionInfo  PrependMagickMethod(ListMagickOptionInfo)
...
#define ModulateHSB  PrependMagickMethod(ModulateHSB)
#define ModulateHSL  PrependMagickMethod(ModulateHSL)
#define ModulateHWB  PrependMagickMethod(ModulateHWB)
...
#define SyncBlob  PrependMagickMethod(SyncBlob)
...
#define TransformHSB  PrependMagickMethod(TransformHSB)
#define TransformHSL  PrependMagickMethod(TransformHSL)
#define TransformHWB  PrependMagickMethod(TransformHWB)
