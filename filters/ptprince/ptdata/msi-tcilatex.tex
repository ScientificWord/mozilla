...
\def\@vcamspecial#1{%
   \msihmode
   \msitag{<graph>}%
      \msitag{<graphSpec ImageFile=} "\expandafter{\expandafter\msigraphicname\msi@getfilename#1VCamFile'';XXXXX}" \msitag{>}%
      ...
      \msitag{<plotwrapper msi_resize="true">} %
         \msitag{<object height="250" width="250" type="application/x-mupad-graphics+xml" data=}%
           "\expandafter{\expandafter\msigraphicname\msi@getfilename#1VCamFile'';XXXXX}"
