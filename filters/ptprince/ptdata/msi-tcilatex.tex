...
\@ifundefined{@TCILATEX}
  {\gdef\@TCILATEX{\relax}%
   \msitopreambleextra{<texb enc="1" name="tcilatex"><![CDATA[\input{tcilatex}]]></texb>}}
  {\endinput}
...
\def\TeXButton#1#2{%
   ...
   \else
     \msihmode\msitag{<texb enc="1" name="}\@wrap{#1}\msitag{"><![CDATA[#2]]></texb>}%
   \fi}
