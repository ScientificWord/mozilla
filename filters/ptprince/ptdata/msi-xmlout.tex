...
\def\msi@pass@newline#1{\def#1{\msi@br\msihmode\msitag{<texb>#1</texb>}}}
...
\def\out@preamble@tex#1{%
   ...
   \msitag{<preambleTeX id="}\the\preambleid\msitag{"><![CDATA[#1]]></preambleTeX>}%
   \preambleToks={}}
...
\def\pagebreak{\msitag{<msibreak type="pageBreak"><newPageRule/></msibreak>}}
