...
\def\msidefault#1{\msitag{[Defaulting: \string#1]}}
...
%% 
%% \def\newcommand{%
%%   \@ifnextchar*{\@newcommand{*}}{\@newcommand{}}}
%% 
%% \def\@newcommand#1{%
%%   \@ifnextchar[{\@newcommandA#1}{\@newcommandA#1[]}}
%% 
%% \def\@newcommandA#1[#2]{%
%%   \@ifnextchar[{\@newcommandB#1[#2]}{\@newcommandB#1[#2][]}}
%% 
%% \def\@newcommandB#1[#2][#3]#4{%
%%   \expandafter\preambleToks\expandafter{\the\preambleToks^^0a\newcommand{#1}[#2][#3]{#4}}%
%%   % Define command
%%   \def#1{\string#1}%
%% }
