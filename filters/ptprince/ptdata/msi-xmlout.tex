...
\def\out@citex[#1]#2{%
  ...
  \msiclosetag{citation}{</citation>\endgroup}}
...
\def\text#1{%
   \msitag{\msipassthru}%
     \char`\{%
     \msiopentag{mml:text}{<mml:mtext>}\begingroup\msihmode #1\endgroup\msiclosetag{mml:text}{</mml:mtext>}%  
     \char`\}}
...
\def\msi@text@elmA[#1]#2{%
  \expandafter\def\csname #2\endcsname##1{%
     ...
     \else
       \msiopentag{#1}{<#1>}##1\msiclosetag{#1}{</#1>}%     
     \fi}}
...
\def\MSITeXButtonReq#1{%
    \expandafter\def\csname#1\endcsname##1{%
       \ifmmode
         ...
         \@temptokena={\msitag{##1}}%       
         \msitag{<texb enc="1" name="#1">}%
            \msihmode<![CDATA[\expandafter\string\csname#1\endcsname\{\the\@temptokena\}]]>%
         \msitag{</texb>}%
         \endgroup
       \else
         \@temptokena={\msitag{##1}}%       
