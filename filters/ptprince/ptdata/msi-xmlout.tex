...
\def\msi@begin@eqnarray{$\string\begin{eqnarray}}
\def\msi@end@eqnarray{\string\end{eqnarray}$}

\@namedef{msi@begin@eqnarray*}{$\string\begin{eqnarray*}}
\@namedef{msi@end@eqnarray*}{\string\end{eqnarray*}$}
