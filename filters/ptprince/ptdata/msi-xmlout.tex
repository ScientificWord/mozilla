...
\def\MSISplitLikeEnvironment#1{%
  \@namedef{msi@begin@#1}{\bgroup\ifmmode\else\msi@dollar=0\relax$$\fi\string\begin{#1}\catcode`\&=12}%
...
\def\text#1{%
   \msitag{\msipassthru}%
     \char`\{%
        \msiopentag{mml:text}{<mml:mtext>}{\msihmode #1}\msiclosetag{mml:text}{</mml:mtext>}%  
     \char`\}}
