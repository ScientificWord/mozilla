...
\def\msi@begin@array{\begingroup\bgroup\def\\{\char`\\}\catcode`\&=11\string\begin{array}}
\def\msi@end@array{\string\end{array}\endgroup}


\def\MSIEqnarrayLikeEnvironment#1{%
  \@namedef{msi@begin@#1}{\bgroup\def\\{\char`\\}\catcode`\&=11\msi@dollar=0\relax$$\string\begin{#1}}%
