...
\def\out@newtheorema#1[#2]#3{%
  \@ifundefined{msi@begin@#1}%
     {\expandafter\preambleToks\expandafter{\the\preambleToks^^0a\newtheorem{#1}[#2]{#3}}
      \@namedef{msi@begin@#1}{\br\msiopentag{theorem}{<theorem type="#1">}\msiopentag{bodyText}{<bodyText>}}
      \@namedef{msi@end@#1}{\br\msiclosetag{bodyText}{</bodyText>}\msiclosetag{theorem}{</theorem>}}}%
     {}%
}
...
%%      \@namedef{msi@begin@#1}{\br\msiopentag{environment}{<environment type="#1">}}
%%      \@namedef{msi@end@#1}{\br\msiclosetag{environment}{</environment>}}}%
%%     {}}%
...
\@namedef{msi@begin@eqnarray}{\bgroup\msi@dollar=0\relax$$\string\begin{eqnarray}}
\@namedef{msi@end@eqnarray}{\string\end{eqnarray}$$\egroup}
...
\def\msi@closetabular{\msiclosetag{table}{</table>}}
