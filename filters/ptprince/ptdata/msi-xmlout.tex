...
\def\out@thanks#1{%
   \msitag{<notewrapper type="footnote" markOrText="undefined">
...
%% %% Newcommand and renewcommand
 ...
 \def\@renewcommandB#1#2[#3][#4]#5{%
   ...
   \if x#3x
   \else
     \expandafter\preambleToks\expandafter{\the\preambleToks^^0a[#3]}%
   \fi
   \if x#4x
   \else
     \expandafter\preambleToks\expandafter{\the\preambleToks^^0a[#4]}\fi
   \expandafter\preambleToks\expandafter{\the\preambleToks^^0a{#5}}}%
...
\def\msi@begin@figureA[#1]{%
   \msiopentag{msiframe}{<msiframe frametype="figure" pos="float" placement="f" placeLocation="#1" >}%
}
...
\def\msi@begin@tableA[#1]{%
   \msiopentag{msiframe}{<msiframe frametype="table" pos="float" placeLocation="#1">}%
}
