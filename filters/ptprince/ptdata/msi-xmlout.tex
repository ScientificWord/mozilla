...
%     {\expandafter\preambleToks\expandafter{\the\preambleToks^^0a\input{tcilatex}}}
   ...
   \msi@inpreamble = 0
   \msi@br\msitag{</head>}
   \msi@br\msiopentag{body}{<body>}
   %%\msihmode\msi@br\msiopentag{docbody}{<docbody>}%
...
\def\out@usepackageA[#1]#2{%
   \msi@br\msitag{<usepackage req="#2" options="#1"/>}}

\def\out@usepackageB#1{%
   \msi@br\msitag{<usepackage req="#1"/>}}

%% \RequirePackage
\def\out@reqpackageA[#1]#2{%
   \msi@br\msitag{<usepackage requirepackage="true" req="#2" options="#1"/>}}

\def\out@reqpackageB#1{%
   \msi@br\msitag{<usepackage requirepackage="true"  req="#1"/>}}
...
\def\ref#1{%
  ...
  \else
    \msitag{<xref key="#1" href="#1" reftype="obj"/>}
  \fi}
...
\def\pageref#1{%
  ...
  \else
    \msitag{<xref key="#1" href="#1" reftype="page"/>}
  \fi}
...
\def\out@bibitemA[#1]#2{%
   ...
   \fi
   \msi@br\msihmode\msiopentag{bibitem}{}<bibitem bibtemkey="#2" hasLabel="true">%
...
\def\out@bibitemB#1{%
   ...
   \else
     ...
     \msiclosetag{bibitem}{</bibitem>}%
   \fi
   \msi@br\msiopentag{bibitem}{<bibitem bibitemkey="}#1\msitag{" hasLabel="false">}%
   \msi@br\msiopentag{bodyText}{<bodyText>}
   \endgroup%
}
