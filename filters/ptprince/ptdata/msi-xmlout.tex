...
\msi@everycellstart{\msihmode\msiopentag{td}{<td>}\msiopentag{bodyText}{<bodyText>}}

%\msi@everycellstart{\chkmulticol}
\def\chkmulticol#1{%
  \ifx#1\multicolumn
    \let\@next#1
  \else
...
\msi@everycellend{\msiclosetag{td}{</td>}}
...
\def\msitabularstarA#1[#2]#3{%
   \begingroup
      ...
      \else
        \mathtabularfalse
      \fi   
      \msiopentag{table}{<table opt="#2" _moz_resizing="true"  cellpadding="4" border="1">}%
...
\def\multicolumn#1#2#3{%
   ...
   \else
      ...
      %\msitag{<td rowspan="1" colspan="#1">#3}%
   \fi
}
