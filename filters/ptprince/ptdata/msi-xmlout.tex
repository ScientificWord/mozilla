...
\def\MSIMathQuote#1{%
   \expandafter\def\csname#1\endcsname{\expandafter\string\csname#1\endcsname\@ifnextchar*{}{\char32}}}
...
\def\out@preamble@tex#1{%
   ...
   \msitag{^^0a<preambleTeX id="}\the\preambleid\msitag{"><![CDATA[#1]]></preambleTeX>}%
   \msi@preamble={}}
...
\def\out@begin@document{%
   ...
   \expandafter\msi@preamble\expandafter{\the\msi@preamble^^0a\usepackage{bm}}%
   \expandafter\msi@preamble\expandafter{\the\msi@preamble^^0a\usepackage{tabulary}}%
...
\def\bibliography#1{%
  \msihmode
  \msitag{<bibtexbibliography xmlns="http://www.w3.org/1999/xhtml" databaseFile="#1" styleFile="}%
  \the@style
  \msitag{"></bibtexbibliography>}}
