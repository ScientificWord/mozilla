...
\msi@everyrowstart{\msitag{<tr>}}
\msi@everyrowend{\msitag{</tr>}}
%\msi@everycellstart{\msihmode\msiopentag{td}{<td>}}

\msi@everycellstart{\msiclosetag{td}{</td>}\chkmulticol}
\def\chkmulticol{%
  \futurelet\@temp\@@chkmulticol}

\def\@@chkmulticol{\expandafter\@chkmulticol\expandafter{\the\@temp}}
...
\def\@chkmulticol#1{%
  ...
  \else
    ...
    \ifmmode
    \else
        \msihmode\msiopentag{bodyText}{<bodyText>}%
    \fi
    \let\@next#1\relax
  \fi
  \@next}
...
\def\MSIEqnarrayLikeEnvironment#1{%
  \@namedef{msi@begin@#1}{\bgroup\def\\{\char`\\\char`\\}\catcode`\&=12\msi@dollar=0\relax$$\string\begin{#1}}%
  \@namedef{msi@end@#1}{\string\end{#1}$$\egroup}}



\def\MSISplitLikeEnvironment#1{%
  \@namedef{msi@begin@#1}{\bgroup\ifmmode\else\msi@dollar=0\relax$$\fi\string\begin{#1}\catcode`\&=11}%
  \@namedef{msi@end@#1}{\string\end{#1}\ifmmode\else$$\fi\egroup}}
...
\def\multicolumn#1#2#3{%
   ...
   \else
      ...
      \msitag{<td rowspan="1" colspan="#1"><bodyText>#3</bodyText></td>}%
   \fi
}
...
\def\,{%
  \ifmmode
    \char`\\\char`\,%
  \else
    \msihmode\msitag{<hspace dim="0.083en" type="thinspace">}\@hex{200a}\msitag{</hspace>}%
  \fi}
...
\def\;{%
  \ifmmode
    \char`\\\char`\;%
  \else
    \msihmode\msitag{<hspace dim="0.083en" type="thickspace">}\@hex{200a}\msitag{</hspace>}%
  \fi}
...
\def\!{%
  \ifmmode
    \char`\\\char`\!%
  \else
    \msihmode\msitag{<hspace dim="0.083en" type="negativethinspace">}\@hex{200a}\msitag{</hspace>}%
  \fi}
...
%\def\msi@mtext#1{\msitag{\msipassthru{<mml:mtext>#1</mml:mtext>}}}

\def\text#1{%
   \msitag{\msipassthru}%
     \char`\{%
        \msitag{<mml:mtext>} #1 \msitag{</mml:mtext>}%  
     \char`\}}
...
\def\MSITeXButtonReq#1{%
    \expandafter\def\csname#1\endcsname##1{%
       ...
       \msihmode
       \msitag{<texb enc="1" name="#1">}%
          <![CDATA[\expandafter\string\csname#1\endcsname\{\the\@temptokena\}]]>%
       \msitag{</texb>}}}
...
\def\@inbrace#1{\@temptokena={\msitag{#1}}\{\the\@temptokena\}\@gobbleargs}
\def\@inbracket[#1]{\@temptokena={\msitag{[#1]}}\the\@temptokena\@gobbleargs}
