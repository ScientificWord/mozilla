\makeatletter
   ...
   \openout\css={css/doc.css} %% the CSS style file for this document
...
\def\pagenumbering#1{\msiopentag{latexstyleb}{<latexstyleb>}\msiopentag{styleprop}
  {<styleprop>}page number style\msiclosetag{styleprop}{</styleprop>}\msiopentag{styledata}{<styledata>}#1
  \msiclosetag{styledata}{</styledata>}\msiclosetag{latexstyleb}{</latexstyleb>}}
...
\def\qquad{\msitag{<hspace dim="2em" type="twoEmSpace">}\@hex{2001}\msitag{</hspace>}}
\def\quad{\msitag{<hspace dim="1em" type="emSpace">}\@hex{2003}\msitag{</hspace>}}
\def\ {\msitag{<hspace type="requiredSpace">}\@hex{205f}\msitag{</hspace>}}
\def~{\msitag{<hspace type="nonBreakingSpace">}\@hex{a0}\msitag{</hspace>}}
\def\/{\msitag{<hspace dim="0.083en" type="italicCorrectionSpace">}\@hex{200a}\msitag{</hspace>}}
...
\def\thinspace{%
   \ifmmode
      \string\thinspace
   \else
     \msitag{<hspace dim="0.17em" type="thinSpace">}\@hex{2009}\msitag{</hspace>}%
   \fi
}
...
\def\thickspace{%
   \ifmmode
      \string\thickspace
   \else
      \msitag{<hspace dim="0.5em" type="thickSpace">}\@hex{2002}\msitag{</hspace>}%
   \fi
}
...
\def\negthinspace{%
   \ifmmode
      \string\negthinspace
   \else
      \msitag{<hspace dim="0.0em" type="negativeThinSpace"></hspace>}%
   \fi
}
