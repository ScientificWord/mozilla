...
\def\index#1{%
  ...
  \fi
  \temptoksa={}%
  \edef\@tmp{\expandafter\@split\@idxentA @\@msi@end}%
  \edef\@tmpEnt{\expandafter\@first\@tmp}
  \edef\@tmpSpcPri{\expandafter\@stripat\expandafter\@second\@tmp}
  \ifx\@tmpEnt\@empty
  \else
     \msitag{<indexitem req="varioref" pri="}\@tmpEnt\msitag{"}%
     \ifx\@tmpSpcPri\@empty
     \else
        \expandafter\temptoksa\expandafter{\the\temptoksa p}
     \fi
     \edef\@tmpA{\expandafter\@split\@idxentB @\@msi@end}%
     \edef\@tmpEnt{\expandafter\@first\@tmpA}
     \edef\@tmpSpcSec{\expandafter\@second\@tmpA}
     \ifx\@tmpEnt\@empty
     \else
       \msitag{ sec="}\@tmpEnt\msitag{"}%
       \ifx\@tmpSpcSec\@empty
       \else
          \expandafter\temptoksa\expandafter{\the\temptoksa s}
       \fi
       \edef\@tmpA{\expandafter\@split\@idxentC @\@msi@end}%
       \edef\@tmpEnt{\expandafter\@first\@tmpA}
       \edef\@tmpSpcTer{\expandafter\@second\@tmpA}%
       \ifx\@tmpEnt\@empty
       \else
         \msitag{ ter="}\@tmpEnt\msitag{"}%
         \ifx\@tmpSpcTer\@empty
         \else
     ...
     \ifx\@tmpSpcPri\@empty
     \else
        \msitag{<prispec>}\@tmpSpcPri\msitag{</prispec>}
     \fi
     \ifx\@tmpSpcSec\@empty
     \else
        \msitag{<secspec>}\@tmpSpcSec\msitag{</secspec>}
     \fi
     \ifx\@tmpSpcTer\@empty
     \else
        \msitag{<terspec>}\@tmpSpcTer\msitag{</terspec>}
     \fi
     \msitag{</indexitem>}%
  \fi
  }%
...
\def\bibitem{\@ifnextchar[{\@lbibitem}{\begingroup\attrib@text\@bibitem}}
