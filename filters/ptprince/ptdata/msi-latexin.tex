...
\catcode`\&=12 % ampersand is alignment tab
...
\bgroup
  ...
  |gdef|@scan@boxedverbatim#1\end{boxedverbatim}[|out@boxedverbatim[#1]%
     |end[boxedverbatim]%
     |@make@braces@normal%
  ]
...
\def\msi@begin@boxedverbatim{%
   ...
   \catcode`\<=\active
   \catcode`\>=\active
   \relax\@scan@boxedverbatim}
   
\def\msi@end@boxedverbatim{}
...
\def\index{\begingroup\attrib@text\@index}
...
\def\@index#1{%
  ...
  \else
     ...
     \else
       \msihmode
     \fi
     \msitag{<indexitem pri="}\@idxentA\msitag{"}%
     \ifx\@idxspecA\@empty
     \else
