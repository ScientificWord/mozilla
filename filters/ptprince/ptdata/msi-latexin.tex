...
%% jcs\def\@minipagefalse{\global\let\if@minipage\iffalse}
%% jcs\def\@minipagetrue {\global\let\if@minipage\iftrue}
%% jcs\@minipagefalse
%% jcs\def\minipage{%
%% jcs  \@ifnextchar[%]
%% jcs    \@iminipage
%% jcs    {\@iiiminipage c\relax[s]}}
%% jcs\def\@iminipage[#1]{%
%% jcs  \@ifnextchar[%]
%% jcs    {\@iiminipage{#1}}%
%% jcs    {\@iiiminipage{#1}\relax[s]}}
%% jcs\def\@iiminipage#1[#2]{%
%% jcs  \@ifnextchar[%]
%% jcs    {\@iiiminipage{#1}{#2}}%
%% jcs    {\@iiiminipage{#1}{#2}[#1]}}
%% jcs\def\@iiiminipage#1#2[#3]#4{%
%% jcs  \leavevmode
%% jcs  \@pboxswfalse
%% jcs  \setlength\@tempdima{#4}%
%% jcs  \def\@mpargs{{#1}{#2}[#3]{#4}}%
%% jcs  \setbox\@tempboxa\vbox\bgroup
%% jcs    \color@begingroup
%% jcs      \hsize\@tempdima
%% jcs      \textwidth\hsize \columnwidth\hsize
%% jcs      \@parboxrestore
%% jcs      \def\@mpfn{mpfootnote}\def\thempfn{\thempfootnote}\c@mpfootnote\z@
%% jcs      \let\@footnotetext\@mpfootnotetext
%% jcs      \let\@listdepth\@mplistdepth \@mplistdepth\z@
%% jcs      \@minipagerestore
%% jcs      \@setminipage}
%% jcs \let\@minipagerestore=\relax
%% jcs\def\endminipage{%
%% jcs    \par
%% jcs    \unskip
%% jcs    \ifvoid\@mpfootins\else
%% jcs      \vskip\skip\@mpfootins
%% jcs      \normalcolor
%% jcs      \footnoterule
%% jcs      \unvbox\@mpfootins
%% jcs    \fi
%% jcs    \@minipagefalse   %% added 24 May 89
%% jcs  \color@endgroup
%% jcs  \egroup
%% jcs  \expandafter\@iiiparbox\@mpargs{\unvbox\@tempboxa}}
%% jcs\newcount\@mplistdepth
%% jcs\newinsert\@mpfootins
%% jcs\long\def\@mpfootnotetext#1{%
%% jcs  \global\setbox\@mpfootins\vbox{%
%% jcs    \unvbox\@mpfootins
%% jcs    \reset@font\footnotesize
%% jcs    \hsize\columnwidth
%% jcs    \@parboxrestore
%% jcs    \protected@edef\@currentlabel
%% jcs         {\csname p@mpfootnote\endcsname\@thefnmark}%
%% jcs    \color@begingroup
%% jcs      \@makefntext{%
%% jcs        \rule\z@\footnotesep\ignorespaces#1\@finalstrut\strutbox}%
%% jcs    \color@endgroup}}
%% jcs\newif\if@pboxsw
\def\@finalstrut#1{%
...
\def\index#1{%
  \msihmode
  \msitag{<indexitem req="varioref"><prisec>#1</prisec></indexitem>}%
}
