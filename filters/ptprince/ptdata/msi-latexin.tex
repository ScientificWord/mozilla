...
\def\maketitle{\out@maketitle}
\def\tableofcontents{\out@tableofcontents}
\def\listoffigures{\out@listoffigures}
\def\listoftables{\out@listoftables}

\def\msi@begin@abstract{\out@begin@abstract}
\def\msi@end@abstract{\out@end@abstract}
...
\def\end#1{%
  \csname msi@end@#1\endcsname\@checkend{#1}%
...
\def\backmatter{\out@backmatter}
\def\appendix{\out@appendix}
...
%%% jcs \DeclareTextFontCommand{\textrm}{\rmfamily}
%%% jcs \DeclareTextFontCommand{\textsf}{\sffamily}
%%% jcs \DeclareTextFontCommand{\texttt}{\ttfamily}
%%% jcs \DeclareTextFontCommand{\textnormal}{\normalfont}
%%% jcs \DeclareTextFontCommand{\textbf}{\bfseries}
%%% jcs \DeclareTextFontCommand{\textmd}{\mdseries}
%%% jcs \DeclareTextFontCommand{\textit}{\itshape}
%%% jcs \DeclareTextFontCommand{\textsl}{\slshape}
%%% jcs \DeclareTextFontCommand{\textsc}{\scshape}
%%% jcs \DeclareTextFontCommand{\textup}{\upshape}
%%% jcs \DeclareTextFontCommand{\emph}{\em}
\let \nocorr \relax
\let \check@icl \@empty
\let \check@icr \@empty
\def \text@command #1{%
...
%%jcs \message{math definitions,}
%%jcs \def\log{\mathop{\operator@font log}\nolimits}
%%jcs \def\lg{\mathop{\operator@font lg}\nolimits}
%%jcs \def\ln{\mathop{\operator@font ln}\nolimits}
%%jcs \def\lim{\mathop{\operator@font lim}}
%%jcs \def\limsup{\mathop{\operator@font lim\,sup}}
%%jcs \def\liminf{\mathop{\operator@font lim\,inf}}
%%jcs \def\sin{\mathop{\operator@font sin}\nolimits}
%%jcs \def\arcsin{\mathop{\operator@font arcsin}\nolimits}
%%jcs \def\sinh{\mathop{\operator@font sinh}\nolimits}
%%jcs \def\cos{\mathop{\operator@font cos}\nolimits}
%%jcs \def\arccos{\mathop{\operator@font arccos}\nolimits}
%%jcs \def\cosh{\mathop{\operator@font cosh}\nolimits}
%%jcs \def\tan{\mathop{\operator@font tan}\nolimits}
%%jcs \def\arctan{\mathop{\operator@font arctan}\nolimits}
%%jcs \def\tanh{\mathop{\operator@font tanh}\nolimits}
%%jcs \def\cot{\mathop{\operator@font cot}\nolimits}
%%jcs \def\coth{\mathop{\operator@font coth}\nolimits}
%%jcs \def\sec{\mathop{\operator@font sec}\nolimits}
%%jcs \def\csc{\mathop{\operator@font csc}\nolimits}
%%jcs \def\max{\mathop{\operator@font max}}
%%jcs \def\min{\mathop{\operator@font min}}
%%jcs \def\sup{\mathop{\operator@font sup}}
%%jcs \def\inf{\mathop{\operator@font inf}}
%%jcs \def\arg{\mathop{\operator@font arg}\nolimits}
%%jcs \def\ker{\mathop{\operator@font ker}\nolimits}
%%jcs \def\dim{\mathop{\operator@font dim}\nolimits}
%%jcs \def\hom{\mathop{\operator@font hom}\nolimits}
%%jcs \def\det{\mathop{\operator@font det}}
%%jcs \def\exp{\mathop{\operator@font exp}\nolimits}
%%jcs \def\Pr{\mathop{\operator@font Pr}}
%%jcs \def\gcd{\mathop{\operator@font gcd}}
%%jcs \def\deg{\mathop{\operator@font deg}\nolimits}
...
%%jcs       \ifvmode
%%jcs          \nointerlineskip
%%jcs          \makebox[.6\linewidth]%
%%jcs       \fi
%%jcs       $$%%$$ BRACE MATCH HACK
%%jcs    \fi
%%jcs }
%%jcs\def\]{%
%%jcs   \relax\ifmmode
...
\def\@lbibitem[#1]#2{\out@bibitemA[{#1}]{#2}}
...
\def\msihyperrefB#1#2#3#4{%
     \xdef\repl{#4}%
     \catcode`\&=4\relax
     \temptoksa={\out@hyperref{#1}{#2}{#3}{\repl}}%
}
