...
//PR_LOG(gPipeFilterListenerLog,PR_LOG_ERROR,args)
#define WARNING_LOG(args)  
//PR_LOG(gPipeFilterListenerLog,PR_LOG_WARNING,args)
#define DEBUG_LOG(args)    
//PR_LOG(gPipeFilterListenerLog,PR_LOG_DEBUG,args)
